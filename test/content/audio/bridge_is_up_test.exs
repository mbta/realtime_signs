defmodule Content.Audio.BridgeIsUpTest do
  ...
  test "Bridge is up (no time estimate) in English" do
    ...
    assert Content.Audio.to_params(audio) == {:sign_content, {"136", [], :audio_visual}}
  end
  ...
  test "Bridge is up (with a time estimate of 5 minutes) in English" do
    ...
    assert Content.Audio.to_params(audio) == {:sign_content, {"135", ["5505"], :audio_visual}}
  end
  ...
  test "Bridge is up (no time estimate) in Spanish" do
    ...
    assert Content.Audio.to_params(audio) == {:sign_content, {"157", [], :audio_visual}}
  end
  ...
  test "Bridge is up (with a time estimate of 5 minutes) in Spanish" do
    ...
    assert Content.Audio.to_params(audio) == {:sign_content, {"152", ["37005"], :audio_visual}}
  end
  ...
  test "When bridge is up with an estimate of 21 minutes, exclude time in Spanish audio" do
    ...
    assert Content.Audio.to_params(audio) == {:sign_content, {"152", [], :audio_visual}}
  end
