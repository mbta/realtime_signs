defmodule Signs.Utilities.PredictionsTest do
  ...
  describe "get_messages/2" do
    ...
    test "when given two source lists, returns earliest result from each" do
      s1 = %SourceConfig{stop_id: "1", direction_id: 0, terminal?: false, platform: nil, announce_arriving?: false}
      s2 = %SourceConfig{stop_id: "2", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      config = {[s1], [s2]}
    ...
    test "when given one source list, returns earliest two results" do
      s1 = %SourceConfig{stop_id: "3", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      s2 = %SourceConfig{stop_id: "4", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      config = {[s1, s2]}
      sign = %{@sign | source_config: config}
    ...
    test "sorts by arrival and departure depending on whether source is a terminal" do
      s1 = %SourceConfig{stop_id: "5", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      s2 = %SourceConfig{stop_id: "6", direction_id: 1, terminal?: true, platform: nil, announce_arriving?: false}
      config = {[s1, s2]}
      sign = %{@sign | source_config: config}
    ...
    test "pads out results if only one prediction" do
      s = %SourceConfig{stop_id: "7", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      config = {[s]}
      sign = %{@sign | source_config: config}
    ...
    test "pads out results if no predictions" do
      s = %SourceConfig{stop_id: "n/a", direction_id: 1, terminal?: false, platform: nil, announce_arriving?: false}
      config = {[s]}
      sign = %{@sign | source_config: config}
    ...
    test "only the first prediction in a source list can be BRD" do
      s = %SourceConfig{stop_id: "8", direction_id: 0, terminal?: false, platform: nil, announce_arriving?: false}
      config = {[s]}
      sign = %{@sign | source_config: config}
