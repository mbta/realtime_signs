defmodule PaEss.Utilities do
  ...
  @spec valid_range?(integer(), Content.Audio.Language.t()) :: boolean()
  ...
  @spec valid_destination?(Content.Audio.Destination.t(), Content.Audio.Language.t()) :: boolean()
  def valid_destination?(destination, language) do
    language == :english or destination in [:chelsea, :south_station]
  end

  @spec number_var(integer(), Content.Audio.Language.t()) :: String.t() | no_return()
