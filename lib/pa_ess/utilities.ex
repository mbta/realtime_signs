defmodule PaEss.Utilities do
  ...
  @spec destination_to_tts_string(PaEss.destination()) :: String.t()
  def destination_to_tts_string(:eastbound), do: "Eastbound"
  def destination_to_tts_string(:inbound), do: "Inbound"
  def destination_to_tts_string(:northbound), do: "Northbound"
  def destination_to_tts_string(:outbound), do: "Outbound"
  def destination_to_tts_string(:silver_line), do: "Silver Line Outbound"
  def destination_to_tts_string(:southbound), do: "Southbound"
  def destination_to_tts_string(:westbound), do: "Westbound"
  def destination_to_tts_string("place-alfcl"), do: "Alewife"
  def destination_to_tts_string("place-alsgr"), do: "Allston Street"
  def destination_to_tts_string("place-amory"), do: "Amory Street"
  def destination_to_tts_string("place-andrw"), do: "Andrew"
  def destination_to_tts_string("place-aport"), do: "Airport"
  def destination_to_tts_string("place-aqucl"), do: "Aquarium"
  def destination_to_tts_string("place-armnl"), do: "Arlington"
  def destination_to_tts_string("place-asmnl"), do: "Ashmont"
  def destination_to_tts_string("place-astao"), do: "Assembly"
  def destination_to_tts_string("place-babck"), do: "Babcock Street"
  def destination_to_tts_string("place-balsq"), do: "Ball Square"
  def destination_to_tts_string("place-bbsta"), do: "Back Bay"
  def destination_to_tts_string("place-bckhl"), do: "Back of the Hill"
  def destination_to_tts_string("place-bcnfd"), do: "Beaconsfield"
  def destination_to_tts_string("place-bcnwa"), do: "Washington Square"
  def destination_to_tts_string("place-bland"), do: "Blandford Street"
  def destination_to_tts_string("place-bmmnl"), do: "Beachmont"
  def destination_to_tts_string("place-bndhl"), do: "Brandon Hall"
  def destination_to_tts_string("place-bomnl"), do: "Bowdoin"
  def destination_to_tts_string("place-boyls"), do: "Boylston"
  def destination_to_tts_string("place-brdwy"), do: "Broadway"
  def destination_to_tts_string("place-brico"), do: "Packard's Corner"
  def destination_to_tts_string("place-brkhl"), do: "Brookline Hills"
  def destination_to_tts_string("place-brmnl"), do: "Brigham Circle"
  def destination_to_tts_string("place-brntn"), do: "Braintree"
  def destination_to_tts_string("place-bucen"), do: "Boston University Central"
  def destination_to_tts_string("place-buest"), do: "Boston University East"
  def destination_to_tts_string("place-butlr"), do: "Butler"
  def destination_to_tts_string("place-bvmnl"), do: "Brookline Village"
  def destination_to_tts_string("place-capst"), do: "Capen Street"
  def destination_to_tts_string("place-ccmnl"), do: "Community College"
  def destination_to_tts_string("place-cedgr"), do: "Cedar Grove"
  def destination_to_tts_string("place-cenav"), do: "Central Avenue"
  def destination_to_tts_string("place-chels"), do: "Chelsea"
  def destination_to_tts_string("place-chhil"), do: "Chestnut Hill"
  def destination_to_tts_string("place-chill"), do: "Chestnut Hill Avenue"
  def destination_to_tts_string("place-chmnl"), do: "Charles/MGH"
  def destination_to_tts_string("place-chncl"), do: "Chinatown"
  def destination_to_tts_string("place-chswk"), do: "Chiswick Road"
  def destination_to_tts_string("place-clmnl"), do: "Cleveland Circle"
  def destination_to_tts_string("place-cntsq"), do: "Central"
  def destination_to_tts_string("place-coecl"), do: "Copley"
  def destination_to_tts_string("place-cool"), do: "Coolidge Corner"
  def destination_to_tts_string("place-davis"), do: "Davis"
  def destination_to_tts_string("place-denrd"), do: "Dean Road"
  def destination_to_tts_string("place-dwnxg"), do: "Downtown Crossing"
  def destination_to_tts_string("place-eliot"), do: "Eliot"
  def destination_to_tts_string("place-engav"), do: "Englewood Avenue"
  def destination_to_tts_string("place-esomr"), do: "East Somerville"
  def destination_to_tts_string("place-fbkst"), do: "Fairbanks Street"
  def destination_to_tts_string("place-fenwd"), do: "Fenwood Road"
  def destination_to_tts_string("place-fenwy"), do: "Fenway"
  def destination_to_tts_string("place-fldcr"), do: "Fields Corner"
  def destination_to_tts_string("place-forhl"), do: "Forest Hills"
  def destination_to_tts_string("place-gilmn"), do: "Gilman Square"
  def destination_to_tts_string("place-gover"), do: "Government Center"
  def destination_to_tts_string("place-grigg"), do: "Griggs Street"
  def destination_to_tts_string("place-grnst"), do: "Green Street"
  def destination_to_tts_string("place-haecl"), do: "Haymarket"
  def destination_to_tts_string("place-harsq"), do: "Harvard"
  def destination_to_tts_string("place-harvd"), do: "Harvard Avenue"
  def destination_to_tts_string("place-hsmnl"), do: "Heath Street"
  def destination_to_tts_string("place-hwsst"), do: "Hawes Street"
  def destination_to_tts_string("place-hymnl"), do: "Hynes Convention Center"
  def destination_to_tts_string("place-jaksn"), do: "Jackson Square"
  def destination_to_tts_string("place-jfk"), do: "JFK/UMass"
  def destination_to_tts_string("place-kencl"), do: "Kenmore"
  def destination_to_tts_string("place-knncl"), do: "Kendall/MIT"
  def destination_to_tts_string("place-kntst"), do: "Kent Street"
  def destination_to_tts_string("place-lake"), do: "Boston College"
  def destination_to_tts_string("place-lech"), do: "Lechmere"
  def destination_to_tts_string("place-lngmd"), do: "Longwood Medical Area"
  def destination_to_tts_string("place-longw"), do: "Longwood"
  def destination_to_tts_string("place-masta"), do: "Massachusetts Avenue"
  def destination_to_tts_string("place-matt"), do: "Mattapan"
  def destination_to_tts_string("place-mdftf"), do: "Medford/Tufts"
  def destination_to_tts_string("place-mfa"), do: "Museum of Fine Arts"
  def destination_to_tts_string("place-mgngl"), do: "Magoun Square"
  def destination_to_tts_string("place-miltt"), do: "Milton"
  def destination_to_tts_string("place-mispk"), do: "Mission Park"
  def destination_to_tts_string("place-mlmnl"), do: "Malden Center"
  def destination_to_tts_string("place-mvbcl"), do: "Maverick"
  def destination_to_tts_string("place-newtn"), do: "Newton Highlands"
  def destination_to_tts_string("place-newto"), do: "Newton Centre"
  def destination_to_tts_string("place-north"), do: "North Station"
  def destination_to_tts_string("place-nqncy"), do: "North Quincy"
  def destination_to_tts_string("place-nuniv"), do: "Northeastern University"
  def destination_to_tts_string("place-ogmnl"), do: "Oak Grove"
  def destination_to_tts_string("place-orhte"), do: "Orient Heights"
  def destination_to_tts_string("place-pktrm"), do: "Park Street"
  def destination_to_tts_string("place-portr"), do: "Porter"
  def destination_to_tts_string("place-prmnl"), do: "Prudential"
  def destination_to_tts_string("place-qamnl"), do: "Quincy Adams"
  def destination_to_tts_string("place-qnctr"), do: "Quincy Center"
  def destination_to_tts_string("place-rbmnl"), do: "Revere Beach"
  def destination_to_tts_string("place-rcmnl"), do: "Roxbury Crossing"
  def destination_to_tts_string("place-river"), do: "Riverside"
  def destination_to_tts_string("place-rsmnl"), do: "Reservoir"
  def destination_to_tts_string("place-rugg"), do: "Ruggles"
  def destination_to_tts_string("place-rvrwy"), do: "Riverway"
  def destination_to_tts_string("place-sbmnl"), do: "Stony Brook"
  def destination_to_tts_string("place-sdmnl"), do: "Suffolk Downs"
  def destination_to_tts_string("place-shmnl"), do: "Savin Hill"
  def destination_to_tts_string("place-smary"), do: "Saint Mary's Street"
  def destination_to_tts_string("place-smmnl"), do: "Shawmut"
  def destination_to_tts_string("place-sougr"), do: "South Street"
  def destination_to_tts_string("place-spmnl"), do: "Science Park/West End"
  def destination_to_tts_string("place-sstat"), do: "South Station"
  def destination_to_tts_string("place-state"), do: "State"
  def destination_to_tts_string("place-sthld"), do: "Sutherland Road"
  def destination_to_tts_string("place-stpul"), do: "Saint Paul Street"
  def destination_to_tts_string("place-sull"), do: "Sullivan Square"
  def destination_to_tts_string("place-sumav"), do: "Summit Avenue"
  def destination_to_tts_string("place-symcl"), do: "Symphony"
  def destination_to_tts_string("place-tapst"), do: "Tappan Street"
  def destination_to_tts_string("place-tumnl"), do: "Tufts Medical Center"
  def destination_to_tts_string("place-unsqu"), do: "Union Square"
  def destination_to_tts_string("place-valrd"), do: "Valley Road"
  def destination_to_tts_string("place-waban"), do: "Waban"
  def destination_to_tts_string("place-wascm"), do: "Washington Street"
  def destination_to_tts_string("place-welln"), do: "Wellington"
  def destination_to_tts_string("place-wimnl"), do: "Wood Island"
  def destination_to_tts_string("place-wlsta"), do: "Wollaston"
  def destination_to_tts_string("place-wondl"), do: "Wonderland"
  def destination_to_tts_string("place-woodl"), do: "Woodland"
  def destination_to_tts_string("place-wrnst"), do: "Warren Street"

  def destination_to_tts_string(destination) do
    Logger.error("Unknown destination: #{inspect(destination)}")
    ""
  end
  ...
  def train_description(destination, route_id, av \\ :audio) do
    ...
    destination_text =
      case av do
        :audio -> destination_to_tts_string(destination)
