...
config :realtime_signs,
  ...
  headway_stations_config: System.get_env("HEADWAY_STATIONS_CONFIG") || "config/static_stations.json",
  static_text_config: System.get_env("STATIC_TEXT_CONFIG") || "config/static_text.json",
